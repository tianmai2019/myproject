...
class CreateUpgradepaymentrecordTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //付款升级记录表
        Schema::create('upgradepaymentrecord', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('upgradepaymentrecord');
    }
}
