...
class CreateCrowdfundingtransferrecordTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //众筹转账提交记录表
        Schema::create('crowdfundingtransferrecord', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('crowdfundingtransferrecord');
    }
}
